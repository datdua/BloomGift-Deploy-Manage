...
const Login = () => {
    ...
    return (
        <div className="login-page" style={{
            backgroundImage: `url('https://firebasestorage.googleapis.com/v0/b/bloom-gift-67f83.appspot.com/o/element-layout%2Fvecto%2Fbanner-authen-manage.png?alt=media&token=346fc884-dcf0-4732-86c6-a292ab58a250')`,
