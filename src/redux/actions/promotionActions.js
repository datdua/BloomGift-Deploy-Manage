...
export const getAllPromotions = () => {
    return async (dispatch) => {
        try {
            const response = await axios.get('https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/get-all', {
                headers: {
...
export const getPromotionByStatus = (promotionStatus) => {
    return async (dispatch) => {
        try {
            const response = await axios.get(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/get-by-promotion-status/${promotionStatus}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                }
            });
...
export const getPromotionById = (promotionID) => {
    return async (dispatch) => {
        try {
            const response = await axios.get(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/get-by-promotionID/${promotionID}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                }
            });
...
export const createPromotion = (storeID, promotionInfo) => {
    return async (dispatch) => {
        try {
            const response = await axios.post(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/create`, promotionInfo, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                }
            });
...
export const updatePromotion = (promotionID, promotionInfo) => {
    return async (dispatch) => {
        try {
            ...
            const response = await axios.put(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/update/${promotionID}`, promotionInfo, {
                headers: {
...
export const deletePromotion = (promotionID) => {
    return async (dispatch) => {
        try {
            const response = await axios.delete(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/promotion/delete/${promotionID}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                }
            });
